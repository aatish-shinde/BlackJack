package com.blackjack.example2;
...
/*
	public static void printWelcomeUser(String name, float wallet) {
		DecimalFormat df = new DecimalFormat("###.##");		
		String welcomeUser = "Welcome " + name + ". You have $" + df.format(wallet) + " available to bet.";
		output.println(welcomeUser);
	}*/
	...
	public static void printWelcome() {
		...
		output.println("$$$$$$$$$$$$$$$$$$$$$");
		output.println("Blackjack pays 3 to 2");
	}
	 ...
	 * getTestDeck()
	 *  
	 *   - For testing purposes. Asks if we should use a test deck.
	 */
	public static Deck getTestDeck() {
		output.println("-- Available Test Decks --");
		output.println("Test Ace Low:.........1");
		output.println("Test BJ:..............2");
		output.println("Test BJ Tie:..........3");
		output.println("Test Split:...........4");
		output.println("Test Split Aces:......5");
		output.println("Test Split BJ:........6");
		output.println("Test SplitSplitSplit:.7");
		output.println("Test Random:..........8");

		int choice;
		output.println("Deck choice must be between 1 and 8.");
		output.print("Enter deck choice: ");
		...
		if(choice == 1)
			return Deck.testAceLow();
		if(choice == 2)
			return Deck.testBJ();
		if(choice == 3)
			return Deck.testBJTie();
		if(choice == 4)
			return Deck.testSplit();
		if(choice == 5)
			return Deck.testSplitAces();
		if(choice == 6)
			return Deck.testSplitBJ();
		if(choice == 7)
			return Deck.testSplitSplitSplit();

		
		return Deck.testRandom();
	}
